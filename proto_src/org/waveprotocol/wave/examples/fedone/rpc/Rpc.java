...
// source: org/waveprotocol/wave/examples/fedone/rpc/rpc.proto
...
public final class Rpc {
  ...
  public static void registerAllExtensions(
    ...
    registry.add(org.waveprotocol.wave.examples.fedone.rpc.Rpc.isStreamingRpc);
  }
  public static final class CancelRpc extends
    ...
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc parseFrom(
    ...
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc parseFrom(
    ...
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc prototype) {
    ...
    public static final class Builder extends
      ...
      private org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc result;
      
      // Construct using org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc();
        return builder;
      }
      ...
      public Builder clear() {
        ...
        result = new org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc();
        return this;
      }
      ...
      public org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc getDefaultInstanceForType() {
      ...
      public org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc build() {
      ...
      private org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
      ...
      public org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
            "build() has already been called on this Builder.");
        }
        org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc returnMe = result;
        result = null;
        return returnMe;
      }
      ...
      public Builder mergeFrom(org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc other) {
        if (other == org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc.getDefaultInstance()) return this;
    ...
    static {
      ...
      org.waveprotocol.wave.examples.fedone.rpc.Rpc.internalForceInit();
  ...
  public static final class RpcFinished extends
    ...
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished parseFrom(
    ...
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished parseFrom(
    ...
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder> {
      private org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished result;
      
      // Construct using org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished();
        return builder;
      }
      ...
      public Builder clear() {
        ...
        result = new org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished();
        return this;
      }
      ...
      public org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished getDefaultInstanceForType() {
      ...
      public org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished build() {
        if (result != null && !isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return buildPartial();
      ...
      private org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
          throw newUninitializedMessageException(
            result).asInvalidProtocolBufferException();
      ...
      public org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
            "build() has already been called on this Builder.");
        }
        org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished returnMe = result;
        result = null;
        return returnMe;
      }
      ...
      public Builder mergeFrom(org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished other) {
        if (other == org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished.getDefaultInstance()) return this;
        if (other.hasFailed()) {
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_rpc_CancelRpc_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc.class,
              org.waveprotocol.wave.examples.fedone.rpc.Rpc.CancelRpc.Builder.class);
          internal_static_rpc_RpcFinished_descriptor =
          ...
          internal_static_rpc_RpcFinished_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished.class,
              org.waveprotocol.wave.examples.fedone.rpc.Rpc.RpcFinished.Builder.class);
          org.waveprotocol.wave.examples.fedone.rpc.Rpc.isStreamingRpc.internalInit(
              org.waveprotocol.wave.examples.fedone.rpc.Rpc.getDescriptor().getExtensions().get(0),
