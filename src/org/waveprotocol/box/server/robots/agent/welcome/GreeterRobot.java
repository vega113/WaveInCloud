...
@Singleton
public class GreeterRobot extends AbstractBaseRobotAgent {
  ...
  private static WaveId welcomeWaveId;

  @Inject
  public GreeterRobot(Injector injector) {
    super(injector);
  ...
  public void welcomeNewUser(ParticipantId id) throws IOException {
    ...
    if (account != null) {
      ...
      if (welcomeWaveId != null) {
        ...
        RobotsUtil.copyWavelet(templateWelcomeWavelet, newWelcomeWavelet);
      } else {
