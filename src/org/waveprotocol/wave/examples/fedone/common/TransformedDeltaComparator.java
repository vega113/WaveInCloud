 ...
 */
public final class TransformedDeltaComparator implements Comparator<ProtocolWaveletDelta> {
  public static final TransformedDeltaComparator INSTANCE = new TransformedDeltaComparator();
  ...
  private TransformedDeltaComparator() {
  }
}
