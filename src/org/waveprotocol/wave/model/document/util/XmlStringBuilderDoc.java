...
public class XmlStringBuilderDoc<N, E extends N, T extends N> extends XmlStringBuilder {
  ...
  /** {@inheritDoc} */
  @Override
  public XmlStringBuilderDoc<N,E,T> wrapWithNs(String ns, String tagName) {
    return wrap(ns + ":" + tagName);
  }
  ...
  /** {@inheritDoc} */
  @Override
  public XmlStringBuilderDoc<N,E,T> wrapWithNs(String ns, String tagName, String... attribs) {
    return wrap(ns + ":" + tagName, attribs);
  }
