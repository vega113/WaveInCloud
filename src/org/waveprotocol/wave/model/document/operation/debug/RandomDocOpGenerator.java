...
public final class RandomDocOpGenerator {
  ...
  public static final class Parameters {
    ...
    // TODO(ohler): We should make attributeValues dependent on attributeNames (and perhaps on
    // element types) so that we can randomly insert chess gadgets with a valid state and inline
    // images with a proper attachment spec.
    //
    // updateAttributes will only generate attribute removals if null is in this
    // list.
        ...
        Collections.unmodifiableList(Arrays.asList(
            new AnnotationOption("link/auto",
                Arrays.asList(null,
                    ...
                    "http://b/createIssue?component=35390")),
  ...
  private static class Generator {
    ...
    class CharactersGenerator extends RandomOperationComponentGenerator {
      ...
      RandomizerOperationComponent generate(DocOpAutomaton a, boolean valid, Stage stage) {
        ...
        if (valid) {
          ...
          // TODO(ohler): implement this once we have size limits.
    ...
    class DeleteCharactersGenerator extends RandomOperationComponentGenerator {
      ...
      RandomizerOperationComponent generate(DocOpAutomaton a, boolean valid, Stage stage) {
        ...
        // TODO(ohler): In stage 2, this should perhaps be less random about how many characters
        ...
        // TODO(ohler): implement invalid case, both by right char but wrong
        ...
        if (b.length() == 0) {
          // TODO(ohler): simplify this method
          return null;
        }
    ...
    class DeleteElementStartGenerator extends RandomOperationComponentGenerator {
      ...
      RandomizerOperationComponent generate(final DocOpAutomaton a, final boolean valid) {
        ...
        switch (a.checkDeleteElementStart(tag, oldAttrs, null)) {
          case ILL_FORMED:
          case INVALID_DOCUMENT: // TODO(ohler): bring back generating invalid ops
          case INVALID_SCHEMA:
            return null;
          case VALID:
            return new RandomizerOperationComponent() {
