...
public interface TargetScroller<M> {
  ...
  /**
   * Can measure the extent of some object.
   */
  interface Measurer<M> {
    /** @return the extent of some measurable. */
    Extent extentOf(M measurable);
  }
  ...
  @SuppressWarnings("unchecked") // unfortunately, parametrising the type
                                 // does not work in some contexts.
  public static final TargetScroller NOOP_IMPL = new TargetScroller() {
    @Override public void moveTo(Object target) {
      // do nothing
    }
  };
}
